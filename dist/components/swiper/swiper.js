...
var Swiper = function (_wx$Component) {
	(0, _inherits3.default)(Swiper, _wx$Component);
	...
	function Swiper() {
		...
		return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Swiper.__proto__ || (0, _getPrototypeOf2.default)(Swiper)).call.apply(_ref, [this].concat(args))), _this), _this.data = {
			imgUrls: [{
