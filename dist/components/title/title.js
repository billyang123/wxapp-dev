...
var string = _labrador2.default.PropTypes.string;
...
var Title = function (_wx$Component) {
  ...
  function Title() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Title.__proto__ || (0, _getPrototypeOf2.default)(Title)).call.apply(_ref, [this].concat(args))), _this), _this.propTypes = {
      text: string
    }, _this.props = {
      text: ''
    }, _this.data = {
