        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _labrador2.default.app.ajax({ url: _labrador2.default.app.data.ajaxPath + "/wxapi/project/getIndexProject" });
              ...
              case 10:
                for (k = 0; k < _data[i].headImg.length; k++) {
                  _data[i].headImg[k] = _labrador2.default.app.setHttpsUrl(_data[i].headImg[k]);
                }
