				...
				return _regenerator2.default.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								if (!(!_labrador2.default.app.globalData.storage && !_labrador2.default.app.globalData.storage.code)) {
									_context3.next = 4;
									break;
								}
							...
							case 6:
								...
								if (myuser.data.loginStatus) {
									myuser.data.headImgUrl = _labrador2.default.app.setHttpsUrl(myuser.data.headImgUrl);
