...
var HealthDetail = function (_wx$Component) {
	...
	(0, _createClass3.default)(HealthDetail, [{
				...
				return _regenerator2.default.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 9:
								url = type == "detail" ? _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qa/praise' : _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qacomment/praise';
								data = {
					...
					while (1) {
						switch (_context3.prev = _context3.next) {
							...
							case 2:
								...
								_context3.next = 5;
								return _labrador2.default.app.ajax({
									url: _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qacomment/list',
									data: {
										qaId: this.data.id,
										page: this.data.page,
										size: this.data.size
							...
							case 10:
								...
								for (i = 0; i < content.length; i++) {
									...
									content[i].headImg = _labrador2.default.app.setHttpsUrl(content[i].headImg);
					...
					while (1) {
						switch (_context5.prev = _context5.next) {
							case 0:
								_context5.next = 2;
								return _labrador2.default.app.ajax({
									url: _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qa/detail',
									data: {
										qaId: this.data.id
									}
								});
							...
							case 2:
								...
								content.healthDoctor.doctorHeadImgUrl = _labrador2.default.app.setHttpsUrl(content.healthDoctor.doctorHeadImgUrl);
								this.setData({
									detail: content
								});
		...
		key: "onLoad",
		value: function () {
			var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(e) {
				var systemInfo;
