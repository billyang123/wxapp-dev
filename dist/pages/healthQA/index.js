						...
						switch (_context2.prev = _context2.next) {
							case 0:
								...
								return _labrador2.default.app.ajax({
									url: _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/doctor/guestList'
								});
							...
							case 2:
								...
								for (i = 0; i < res.data.content.length; i++) {
									res.data.content[i].doctorHeadImgUrl = _labrador2.default.app.setHttpsUrl(res.data.content[i].doctorHeadImgUrl);
								}
								this.setData({
					...
					while (1) {
						switch (_context6.prev = _context6.next) {
							case 0:
								_context6.next = 2;
								return _labrador2.default.app.ajax({
									url: _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qa/labellist',
									type: "get"
								});
