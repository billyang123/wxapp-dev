						...
						switch (_context.prev = _context.next) {
							...
							case 2:
								...
								return _labrador2.default.app.ajax({
									url: _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/doctor/list',
									data: {
										page: this.data.page,
										size: this.data.size
									}
							...
							case 10:
								...
								for (i = 0; i < content.length; i++) {
									content[i].doctorHeadImgUrl = _labrador2.default.app.setHttpsUrl(content[i].doctorHeadImgUrl);
								}
								this.setData({
									hasMore: loadMore,
