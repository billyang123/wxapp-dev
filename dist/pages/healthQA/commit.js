						...
						switch (_context.prev = _context.next) {
							...
							case 16:
								...
								n_data = {
									...
									content: content,
									time: _labrador2.default.app.dateformat(tme, "-", ":")
								};
						...
						switch (_context3.prev = _context3.next) {
							case 0:
								...
								if (e.qaCommentId) {
									...
									this.url = _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qacomment/reply';
								}
								if (e.qaId) {
									this.postdata.qaId = e.qaId;
									this.qaId = e.qaId;
									this.url = _labrador2.default.app.data.ajaxPath + '/wxapi/healthserv/qacomment/add';
								}
								//console.log(e)
