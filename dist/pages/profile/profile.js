        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                userInfo = _labrador2.default.app.globalData.userInfo;
                _context.next = 3;
                return _labrador2.default.request({
                  url: _labrador2.default.app.data.ajaxPath + '/wxapi/user/userInfo/index',
                  method: "GET",
                  header: {
              ...
              case 3:
                ...
                if (res.data.status == 0) {
                  this.setData({
                    ...
                    userHeadimgurl: _labrador2.default.app.setHttpsUrl(res.data.data.userHeadimgurl) || userInfo.avatarUrl
                  });
                }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _labrador2.default.request({
                  url: _labrador2.default.app.data.ajaxPath + "/wxapi/user/userInfo/gender",
                  method: "GET",
                  header: {
                    'content-type': 'application/x-www-form-urlencoded'
                  },
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                _context4.next = 6;
                return _labrador2.default.request({
                  url: _labrador2.default.app.data.ajaxPath + "/wxapi/user/userInfo/modifyGender",
                  method: "POST",
                  header: {
                    'content-type': 'application/x-www-form-urlencoded'
                  },
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                _context5.next = 5;
                return _labrador2.default.request({
                  url: _labrador2.default.app.data.ajaxPath + "/wxapi/user/logout",
                  method: "GET",
                  header: {
                    'content-type': 'application/x-www-form-urlencoded'
                  },
